...
public class PlayerControllerBinder : MonoBehaviour
{
    ...
    private void Update()
    {
        m_Jump = _playerControlls.jump.isHeld;
    }
    ...
    {
        // read inputs
        float h = _playerControlls.moveX.value;
        float v = _playerControlls.moveY.value;
